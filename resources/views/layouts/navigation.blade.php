<nav x-data="{ open: false }" class="bg-base">
    ...
    <div class="max-w-7xl mx-auto">
            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('profile.edit')" @class(['text-primary' => request()->routeIs('profile.edit')])>
                                {{ __('Profile') }}
                            </x-dropdown-link>
        ...
        <div class="w-full h-[1px] bg-gradient-radial"></div>
    </div>
