    ...
    <div class="max-w-7xl mx-auto flex gap-x-6 gap-y-6 mt-4">
        <div class="w-3/12">
            <x-card class="overflow-hidden w-full" style="padding:0;">
                <div style="background-image:url('{{ Vite::asset('resources/images/bg-auth.svg') }}')"
                    ...
                    <div class="rounded-lg w-20 aspect-square bg-black absolute -bottom-1/2 left-6 overflow-hidden">
                        <img src="{{ Storage::url($company->logo) }}" class="h-full object-cover" alt="">
                    </div>
                </div>
                <div class="p-8">
                    ...
                    <div class="flex -mx-8 flex-col">
                        ...
                        <a href="{{ route('vacancies.admin.index', ['company_id' => $company->id]) }}" class="w-full px-8 py-3 hover:bg-gray_soft text-slate-600 border-l-2">
                            Manage Vacancies
                        </a>
                        <a href="{{ route('vacancies.admin.index', ['company_id' => $company->id]) }}" class="w-full px-8 py-3 hover:bg-gray_soft text-slate-600 border-l-2">
                            Manage Applicants
        ...
        <div class="w-6/12 self-start">
            <x-card class="flex gap-x-4 items-start">
                <div class="w-14 bg-black aspect-square rounded-full overflow-hidden">
                    <img src="{{ Storage::url($company->logo) }}" class="h-full object-cover" alt="">
                </div>
                <div class="w-full">
                    <input
