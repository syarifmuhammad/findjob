<x-app-layout class="py-3">
    <div class="max-w-7xl mx-auto flex gap-x-6 gap-y-6 mt-4">
        ...
        <div class="w-9/12">
            <x-card class="w-full">
                <h1 class="font-semibold text-xl mb-4">Recruitment</h1>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex gap-x-3 overflow-x-hidden">
                        ...
                        <x-badge>Music Event</x-badge>
                        <x-badge>Job Fair Event</x-badge>
                    </div>
                ...
                <div class="mt-6">
                    @for ($i = 0; $i < 3; $i++)
                        <div class="w-full flex items-start justify-between mb-6">
                            ...
                            <x-secondary-button class="text-xs px-6 py-3 self-center">Join Now</x-secondary-button>
                        </div>
                    @endfor
                </div>
            </x-card>
